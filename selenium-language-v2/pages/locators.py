...
class BasePageLocators():
    ...
    USER_LOGOUT = (By.CSS_SELECTOR, '[id="logout_link"]')  # проверка наличия иконки выхода

class BasketPageLocators():
    BASKET_LINK = (By.CSS_SELECTOR, "div.basket-mini.pull-right.hidden-xs> span> a")  # на каждой странице такой же локатор?
